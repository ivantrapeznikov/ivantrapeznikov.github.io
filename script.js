...
const paintingsData = {
    ...
    // Картина №2: Весеннее утро (бывшая №1)
    2: {
        title: "«Весеннее утро»",
        year: "2026",
        size: "60×80 см",
    ...
    // Картина №3: Гроза надвигается (бывшая №2)
    3: {
    ...
    // Картина №4: Северная ночь в горах (бывшая №3)
    4: {
    ...
    // Картина №5: Утро в деревне (бывшая №4)
    5: {
    ...
    // Картина №6: Молчаливое общение (бывшая №5)
    6: {
    ...
    // Картина №7: Море. Полярная ночь (бывшая №6)
    7: {
    ...
    // Картина №9: У чёрного моря (бывшая №8)
    9: {
